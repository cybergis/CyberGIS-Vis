(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var css_lasso = ".leaflet-lasso-active {\n    cursor: crosshair;\n    -webkit-user-select: none;\n       -moz-user-select: none;\n        -ms-user-select: none;\n            user-select: none;\n}\n\n.leaflet-lasso-active .leaflet-interactive {\n    cursor: crosshair;\n    pointer-events: none;\n}";
	var css_globe = ".leaflet-lasso-active {\n    cursor: default;\n    -webkit-user-select: none;\n       -moz-user-select: none;\n        -ms-user-select: none;\n            user-select: none;\n}\n\n.leaflet-lasso-active .leaflet-interactive {\n    cursor: default;\n    pointer-events: none;\n}";
    //styleInject(css);
	...
	var css$1_lasso = ".leaflet-control-lasso {\n    background: url('data:image/png;base64,');\n    background-size: 22px;\n}";
	
    var css$1_globe = ".leaflet-control-lasso {\n    background: url('data:image/png;base64,');\n    background-size: 22px;\n}";
    //styleInject(css$1);
    ...
    var LassoControl = /** @class */ (function (_super) {
        ...
        function LassoControl(options) {
            ...
            L.Util.setOptions(_this, options);
			if ('icon' in this.options && this.options.icon == 'globe') {
				styleInject(css_globe);
				styleInject(css$1_globe);
			} else {
				styleInject(css_lasso);
				styleInject(css$1_lasso);
			}
